        ...
        void m_WebSocket_MessageReceived(object sender, MessageReceivedEventArgs e)
        {
            ...
            try
            {
                if (!executor.Type.IsSimpleType())
                    value = JsonConvert.DeserializeObject(parameter, executor.Type);
            ...
            {
                m_WebSocket_Error(this, new SuperSocket.ClientEngine.ErrorEventArgs(new Exception("DeserializeObject exception", exc)));
                return;
            }
            ...
            {
                m_WebSocket_Error(this, new SuperSocket.ClientEngine.ErrorEventArgs(new Exception("Message handling exception", exce)));
            }
        }
