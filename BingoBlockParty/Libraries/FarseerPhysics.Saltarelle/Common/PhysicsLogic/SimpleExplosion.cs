...
namespace FarseerPhysics.Common.PhysicsLogic
{
    ...
    public sealed class SimpleExplosion : PhysicsLogic
    {
        ...
        {
            List<Body> affectedBodies = new List<Body>();

            AABB aabb=new AABB(new Vector2(),new Vector2() );
        ...
        private Dictionary<Body, Vector2> ApplyImpulse(Vector2 pos, float radius, float force, float maxForce, List<Body> overlappingBodies)
        {
