...
namespace FarseerPhysics.Common
{
    ...
    {
        public Vertices() { InternalList = new List<Vector2>(); }

        public Vertices(int capacity) { InternalList = new List<Vector2>(capacity); }

        public Vertices(IEnumerable<Vector2> vertices)
        {
            InternalList = new List<Vector2>();
            InternalList.AddRange(vertices);
        }
        ...
        public List<Vector2> InternalList;
