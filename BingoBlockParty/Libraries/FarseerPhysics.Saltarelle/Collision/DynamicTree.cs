...
namespace FarseerPhysics.Collision
{
    ...
    {
        private Stack<int> _raycastStack = new Stack<int>();
        private Stack<int> _queryStack = new Stack<int>();
        ...
        public int AddProxy(AABB aabb, T userData)
        {
        ...
        private int AllocateNode()
        {
            ...
            if (_freeList == NullNode)
            {
                ...
                _nodeCapacity *= 2;
                _nodes = new TreeNode<T>[_nodeCapacity];
                ArrayUtils.Copy(oldNodes, _nodes, _nodeCount);
